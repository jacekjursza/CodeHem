...
class TemplateMethodExtractor(TemplateExtractor):
    ...
    def _process_tree_sitter_results(self, query_results, code_bytes, ast_handler, context):
        ...
        # First pass - collect all method definitions and decorators
    ...
    def _process_regular_methods(self, method_nodes, methods, code_bytes, ast_handler, context, decorator_nodes):
        ...
        for method_name, method_node in method_nodes.items():
            ...
            method_info = {
                ...
                'range': {
                    'start': {'line': method_node.start_point[0] + 1, 'column': method_node.start_point[1]},
                    'end': {'line': method_node.end_point[0] + 1, 'column': method_node.end_point[1]}
                },
    ...
    def _get_class_name(self, node, context, ast_handler, code_bytes):
        ...
        if context.get('class_name'):
            ...
            if not class_node:
                # For TypeScript/JavaScript, try class_declaration
    ...
    def _process_regex_results(self, matches, code, context):
        ...
        # If we have a class name, find its range in the code
        class_content = code
        class_offset = 0
        if class_name:
        ...
        # Find methods in the class content
        ...
        for match in matches:
            ...
            # Find the end of the method by matching indentation
    ...
    def _extract_return_info_regex(self, content):
        ...
        # Try to get explicit return type annotation
