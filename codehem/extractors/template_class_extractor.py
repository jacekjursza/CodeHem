    ...
    def _process_tree_sitter_results(self, query_results, code_bytes, ast_handler, context):
        ...
        for class_name, class_def in class_nodes.items():
            ...
            class_info = {
                ...
                'content': content,
                'range': {
                    'start': {'line': class_def.start_point[0] + 1, 'column': class_def.start_point[1]},
                    'end': {'line': class_def.end_point[0] + 1, 'column': class_def.end_point[1]}
                },
        ...
        for match in matches:
            ...
            class_info = {
                ...
                'range': {
                    ...
                    'end': {'line': lines_total + 1, 'column': end_column}
                },
                'decorators': decorators,
                'members': {
                    'methods': [],
