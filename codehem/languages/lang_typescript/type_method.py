# New file: d:\code\codehem\codehem\languages\lang_typescript\type_method.py
import logging
...
class TypeScriptMethodHandlerElementType(ElementTypeLanguageDescriptor):
    """ Handler descriptor for TypeScript/JavaScript method elements. """
    _LANGUAGE: str = 'typescript'
    _TYPE: CodeElementType = CodeElementType.METHOD
