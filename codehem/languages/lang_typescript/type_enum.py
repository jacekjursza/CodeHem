# New file: d:\code\codehem\codehem\languages\lang_typescript\type_enum.py
import logging
...
class TypeScriptEnumHandlerElementType(ElementTypeLanguageDescriptor):
    """ Handler descriptor for TypeScript enum elements. """
    _LANGUAGE: str = 'typescript'
    _TYPE: CodeElementType = CodeElementType.ENUM
