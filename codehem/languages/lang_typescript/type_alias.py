# New file: d:\code\codehem\codehem\languages\lang_typescript\type_alias.py
import logging
...
class TypeScriptTypeAliasHandlerElementType(ElementTypeLanguageDescriptor):
    """ Handler descriptor for TypeScript type alias elements. """
    _LANGUAGE: str = 'typescript'
    _TYPE: CodeElementType = CodeElementType.TYPE_ALIAS
