# Content of codehem\languages\lang_python\type_property_setter.py
import logging
...
class PythonPropertySetterHandlerElementType(ElementTypeLanguageDescriptor):
    """Handler descriptor for Python property setter elements."""
    # Define constants for registration and identification
    _LANGUAGE = 'python'
    _TYPE = CodeElementType.PROPERTY_SETTER
