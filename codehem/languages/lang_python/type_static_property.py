# Content of codehem\languages\lang_python\type_static_property.py
import logging
...
class PythonStaticPropertyHandlerElementType(ElementTypeLanguageDescriptor):
    """Handler descriptor for Python static property elements."""
    # Define constants for registration and identification
    _LANGUAGE = 'python'
    _TYPE = CodeElementType.STATIC_PROPERTY
