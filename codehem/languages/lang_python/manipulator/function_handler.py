...
class PythonFunctionManipulator(PythonBaseManipulator):
    ...
    def format_element(self, element_code: str, indent_level: int = 0) -> str:
        ...
        result = []
        func_line_idx = next((i for i, line in enumerate(lines) 
                              if line.strip().startswith('def ')), 0)
        
        # Add any lines before the function definition (like decorators)
        ...
        func_indent = indent + '    '  # 4 spaces for function body
        
        # Process the function body with proper indentation
    ...
    def find_element(self, code: str, function_name: str, 
                    parent_name: Optional[str] = None) -> Tuple[int, int]:
        """Find a function in Python code"""
        return self.finder.find_function(code, function_name)
    
    def replace_element(self, original_code: str, function_name: str, 
    ...
    def add_element(self, original_code: str, new_element: str,
        ...
        # Ensure there are empty lines before and after the new function
    ...
    def remove_element(self, original_code: str, function_name: str,
                      parent_name: Optional[str] = None) -> str:
