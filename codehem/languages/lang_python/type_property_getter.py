# Content of codehem\languages\lang_python\type_property_getter.py
import logging
...
class PythonPropertyGetterHandlerElementType(ElementTypeLanguageDescriptor):
    """Handler descriptor for Python property getter elements."""
    # Define constants for registration and identification
    _LANGUAGE = 'python'
    _TYPE = CodeElementType.PROPERTY_GETTER
