...
from ...models import CodeElementsResult
...
class PythonLanguageService(BaseLanguageService):
    ...
    def extract(self, code: str) -> CodeElementsResult:
        ...
        extraction_service = PythonExtractionService(self.finder, self.finder)
        return extraction_service.extract_code_elements(code)
