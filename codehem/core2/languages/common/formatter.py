"""
Common formatter implementation shared across language modules.
"""
import re
from typing import Optional
from ...engine.base_formatter import BaseFormatter

class CommonFormatter(BaseFormatter):
    """
    Common implementation of code formatter with shared functionality.
    Language-specific formatters should extend this class.
    """
    
    def __init__(self, indent_size: int = 4):
        """
        Initialize the common formatter.
