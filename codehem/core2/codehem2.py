...
from codehem.core2 import CodeElement
from .models import CodeElementsResult, CodeElementType, CodeElementXPathNode
from .languages import get_language_service, get_language_service_for_file, get_language_service_for_code, get_supported_languages
from .languages.registrations import register_language_service
...
class CodeHem2:
    ...
    def upsert_element_by_xpath(self, original_code: str, xpath: str, new_code: str) -> str:
        ...
        # If element type wasn't specified in XPath, detect it from the new code
        if not element_type:
    ...
    def filter(elements: CodeElementsResult, xpath: str='') -> Optional[CodeElement]:
        ...
        # Parse the XPath to get element name, parent name, and type
        element_name, parent_name, element_type = XPathParser.get_element_info(xpath)
        ...
        for element in elements.elements:
            if hasattr(element, 'name') and element.name == element_name:
                ...
                # Make sure it's not a child element
