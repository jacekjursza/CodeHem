...
# Import will occur lazily in each method
...
class PythonPostProcessor(LanguagePostProcessor):
    ...
    def process_functions(self, raw_functions: List[Dict], 
                        all_decorators: Optional[List[Dict]]=None) -> List[Any]:
        """
    ...
    def _process_parameters(self, element: Any, params_data: List[Dict]) -> List[Any]:
        """
    ...
    def _process_return_value(self, element: Any, return_info: Dict) -> Optional[Any]:
        """
    ...
    def _process_method_element(self, method_data: Dict, parent_class_element: Any) -> Optional[Any]:
        """
    ...
    def _process_static_property(self, prop_data: Dict, parent_class_element: Any) -> Optional[Any]:
        """
    ...
    def _process_decorators(self, element_data: Dict) -> List[Any]:
        """
    ...
    def _process_decorator_element(self, dec_data: Dict, parent_name: Optional[str] = None) -> Optional[Any]:
        """
