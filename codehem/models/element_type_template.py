...
class ElementTypeTemplate:
    ...
    element_type: str
    description: str
    tree_sitter_pattern: str  # With placeholders {CLASS_NAME}, {METHOD_NAME}, etc.
    regexp_pattern: str  # With placeholders {CLASS_PATTERN}, {METHOD_PATTERN}, etc.
...
# Standard templates for common element types
...
METHOD_TEMPLATE = ElementTypeTemplate(
    ...
    placeholder_map={
        ...
        "typescript": {
            ...
            "FIRST_PARAM_PATTERN": "",  # No self in TS
            "BODY_NODE": "statement_block",
            "METHOD_PATTERN": "",  # No def/function keyword for methods in TS
